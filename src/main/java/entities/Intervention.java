...
public class Intervention implements Serializable {
    ...
    public String toString() {
        return "Intervention{" + "id=" + id + ", version=" + version + ", description=" + description + ", startDate=" + startDate + ", endDate=" + endDate + ", comment=" + comment + ", success=" + success + ", client=" + (client != null ? client.getId() : "null") + ", employee=" + (employee != null ? employee.getId() : "null") + '}';
    }
