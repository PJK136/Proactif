...
import fr.insalyon.dasi.services.util.ConsoleIO;
import fr.insalyon.dasi.services.util.CsvConvert;
...
public class Scenario {
    ...
    private static class ChargementDonneesTest extends Action {
        final static String DATA_PATH = "src/main/resources/fr/insalyon/dasi/mockData/";
